...
public class MailService {
    ...
    public void sendVerificationEmail(User data) throws MessagingException, UnsupportedEncodingException {
        String toAddress = data.getEmail();
        String fromAddress = "igorabreu.dev@gmail.com";
        String senderName = "Abreu";
        ...
        String verifyURL = this.verifyURL + data.getVerificationCode();
